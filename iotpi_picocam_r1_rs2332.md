...
> No.( Firmware includes GPLv3 software, we cannot fully encrypt and lock down the whole system. But we have encrypted and lock / verify core software with TrustZone Technology embedded in SoC)
