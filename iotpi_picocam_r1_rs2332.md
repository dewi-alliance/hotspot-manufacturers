...
* Are you using an ECC608. Yes or No? `No, this product is using RS2332 from RANiX`
* Encrypted/locked-down firmware. Yes or No? `No.( Firmware includes GPLv3 software, we cannot fully encrypt and lock down the whole system. But we have\
      encrypt and lock / verify core software with TrustZone Technology embedded in SoC)`
* Encrypted storage of the miner swarm_key, either via disk encryption or hardware measures. Yes or No? `Yes, stored securely inside RS2332`
