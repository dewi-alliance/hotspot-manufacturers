...
Main operations: set-top boxes, gateways, smart platforms.
...
Most configurations are same to the full hotspot of Coship, which is audited by Helium Foundation, we would make some adjustments on the CUP. 
* 
